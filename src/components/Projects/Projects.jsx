...
const Projects = () => {
    ...
    const cards = [
        { img: img1, title: 'AJA: Gamification of Programming Language', sourceCode: '', bg: 'a', description: 'My Capstone Project back in my college days. This project is an E-learning game with scoring functionality and challenges that helps student enjoy learning more about Computer Programming.' },
